...
#define KC_FNI1 LT(_FN3, KC_LNG1)
#define KC_FNI2 LT(_FN3, KC_LNG2)
// #define KC_SHBS MT(MOD_LSFT, KC_INT3)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_iso_70(
        KC_ESC,   KC_1,     KC_2,     KC_3,    KC_4,    KC_5,    KC_6,     KC_7,     KC_8,    KC_9,    KC_0,     KC_MINS,  KC_EQL,   KC_INT3,          KC_MUTE,
        KC_TAB,   KC_Q,     KC_W,     KC_E,    KC_R,    KC_T,    KC_Y,     KC_U,     KC_I,    KC_O,    KC_P,     KC_LBRC,  KC_RBRC,                    KC_BSPC,
        KC_LCTL,  KC_A,     KC_S,     KC_D,    KC_F,    KC_G,    KC_H,     KC_J,     KC_K,    KC_L,    KC_SCLN,  KC_QUOT,  KC_NUHS,  KC_ENT,           KC_HOME,
        KC_LSFT,  KC_LSFT,  KC_Z,     KC_X,    KC_C,    KC_V,    KC_B,     KC_B,     KC_N,    KC_M,    KC_COMM,  KC_DOT,   KC_SLSH,  S(KC_INT1), KC_UP,
        MO(_FN1), KC_LOPT,  KC_LCMD,           KC_FNI2,          KC_SPC,   KC_SPC,            KC_FNI1,           KC_RCMD,            KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [WIN_BASE] = LAYOUT_iso_70(
        ...
        KC_LCTL, KC_LWIN,  KC_LALT,           MO(_FN2),         KC_SPC,   KC_SPC,            MO(_FN3),          KC_RALT,            KC_LEFT, KC_DOWN, KC_RGHT),
